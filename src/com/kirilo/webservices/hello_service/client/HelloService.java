 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://server.hello_service.webservices.kirilo.com/", wsdlLocation = "http://localhost:8989/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://server.hello_service.webservices.kirilo.com/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://server.hello_service.webservices.kirilo.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.hello_service.webservices.kirilo.com/", "HelloPort"), Hello.class, features);
    }
