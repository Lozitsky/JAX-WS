 ...
 * generated in the com.kirilo.webservices.hash_service.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _HashStringResponse_QNAME = new QName("http://server.hash_service.webservices.kirilo.com/", "hashStringResponse");
    private final static QName _HashString_QNAME = new QName("http://server.hash_service.webservices.kirilo.com/", "hashString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.kirilo.webservices.hash_service.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hash_service.webservices.kirilo.com/", name = "hashStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hash_service.webservices.kirilo.com/", name = "hashString")
